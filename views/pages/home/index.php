...
?>
            ...
            <input type="text" placeholder="City, State, or Country..." title="City, State, or Country..." name="location" id="location" style="width:482px;" value="<?php defaultval($form, 'location'); ?>" />
    ...
    <input type="email" name="email" id="email" placeholder="e-mail address" value="<?php defaultval($form, 'email'); ?>" /><br />
    <input id="submit-button" type="submit" class="submit-button" title="Add This Notification!" value="" />
    </div>
